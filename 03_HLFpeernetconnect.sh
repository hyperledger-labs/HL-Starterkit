...
function org3sedscrpt() {
    ...
    #docker exec $CLI_NAME bash ./scripts/14B_anchorpeerorg3.sh  ### Rem for public access
    #sleep 2
    #
   ...
   # docker exec $CLI_NAME bash ./scripts/14C_ccinstallpeer0.org3.sh ### Rem for public access
    #sleep 1
