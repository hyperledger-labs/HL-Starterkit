...
peer lifecycle chaincode approveformyorg --channelID mychannel --name $CC_LABLNAME --version 1.0 --init-required --package-id $PACKAGE_ID  --sequence 1 -o {ORD_NAME0}:7050 --tls --cafile $ORDERER_CA


echo " commiting "
peer lifecycle chaincode commit -o {ORD_NAME0}:7050 --channelID mychannel --name $CC_LABLNAME --version 1.0 --sequence 1 --init-required --tls true --cafile $ORDERER_CA $PEER_CONN_PARMS $PEER_CONN_PARMS1
