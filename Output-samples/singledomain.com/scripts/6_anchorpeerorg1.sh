...
echo -e $PCOLOR"Making the p0.org1 as AnchorPeer for org1 to mychannel ..."$NONE
#set -x
...
peer channel update -o orderer0.singledomain.com:7050 -c mychannel -f ./channel-artifacts/Org1MSPanchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
