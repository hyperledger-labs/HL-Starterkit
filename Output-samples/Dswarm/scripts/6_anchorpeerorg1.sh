...
echo -e $PCOLOR"Making the peer0.org1 as AnchorPeer for org1 to mychannel ..."$NONE
#set -x
...
ORDERER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/dstest.com/orderers/orderer0.dstest.com/msp/tlscacerts/tlsca.dstest.com-cert.pem
#CHANNEL_NAME=mychannel2
peer channel update -o orderer0.dstest.com:7050 -c mychannel -f ./channel-artifacts/Org1MSPanchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
